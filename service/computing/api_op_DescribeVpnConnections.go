...
// VpnConnectionExistsWaiterOptions are waiter options for
// VpnConnectionExistsWaiter
...
type VpnConnectionExistsWaiter struct {
	...
	options VpnConnectionExistsWaiterOptions
}
...
func NewVpnConnectionExistsWaiter(client DescribeVpnConnectionsAPIClient, optFns ...func(*VpnConnectionExistsWaiterOptions)) *VpnConnectionExistsWaiter {
	...
	options.Retryable = vpnConnectionExistsStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &VpnConnectionExistsWaiter{
		client:  client,
		options: options,
	}
}
...
// WaitForOutput calls the waiter function for VpnConnectionExists waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *VpnConnectionExistsWaiter) WaitForOutput(ctx context.Context, params *DescribeVpnConnectionsInput, maxWaitDur time.Duration, optFns ...func(*VpnConnectionExistsWaiterOptions)) (*DescribeVpnConnectionsOutput, error) {
	if maxWaitDur <= 0 {
	...
	return nil, fmt.Errorf("exceeded max wait time for VpnConnectionExists waiter")
}

func vpnConnectionExistsStateRetryable(ctx context.Context, input *DescribeVpnConnectionsInput, output *DescribeVpnConnectionsOutput, err error) (bool, error) {

	if err == nil {
		pathValue, err := jmespath.Search("length(VpnConnectionSet[]) > `0`", output)
		if err != nil {
	...
	if err != nil {
		...
		if "Client.InvalidParameterNotFound.VpnConnectionId" == apiErr.ErrorCode() {
			return true, nil
		}
	}
...
func vpnConnectionAvailableStateRetryable(ctx context.Context, input *DescribeVpnConnectionsInput, output *DescribeVpnConnectionsOutput, err error) (bool, error) {
	...
	if err == nil {
		pathValue, err := jmespath.Search("VpnConnectionSet[].State", output)
		if err != nil {
			return false, fmt.Errorf("error evaluating waiter state: %w", err)
		}
