...
// CustomerGatewayExistsWaiterOptions are waiter options for
// CustomerGatewayExistsWaiter
type CustomerGatewayExistsWaiterOptions struct {
	...
	// to zero, CustomerGatewayExistsWaiter will use default max delay of 120 seconds.
...
type CustomerGatewayExistsWaiter struct {
	...
	options CustomerGatewayExistsWaiterOptions
}
...
func NewCustomerGatewayExistsWaiter(client DescribeCustomerGatewaysAPIClient, optFns ...func(*CustomerGatewayExistsWaiterOptions)) *CustomerGatewayExistsWaiter {
	...
	options.Retryable = customerGatewayExistsStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &CustomerGatewayExistsWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for CustomerGatewayExists waiter. The maxWaitDur
// is the maximum wait duration the waiter will wait. The maxWaitDur is required
// and must be greater than zero.
func (w *CustomerGatewayExistsWaiter) Wait(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayExistsWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for CustomerGatewayExists waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *CustomerGatewayExistsWaiter) WaitForOutput(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayExistsWaiterOptions)) (*DescribeCustomerGatewaysOutput, error) {
	if maxWaitDur <= 0 {
	...
	return nil, fmt.Errorf("exceeded max wait time for CustomerGatewayExists waiter")
}

func customerGatewayExistsStateRetryable(ctx context.Context, input *DescribeCustomerGatewaysInput, output *DescribeCustomerGatewaysOutput, err error) (bool, error) {

	if err == nil {
		pathValue, err := jmespath.Search("length(CustomerGatewaySet[]) > `0`", output)
		if err != nil {
	...
	if err != nil {
		...
		if "Client.InvalidParameterNotFound.CustomerGatewayName" == apiErr.ErrorCode() {
			return true, nil
		}
	}
	...
	if err != nil {
		...
		if "Client.InvalidParameterNotFound.CustomerGatewayId" == apiErr.ErrorCode() {
			return true, nil
		}
	}
...
func customerGatewayAvailableStateRetryable(ctx context.Context, input *DescribeCustomerGatewaysInput, output *DescribeCustomerGatewaysOutput, err error) (bool, error) {
	...
	if err == nil {
		pathValue, err := jmespath.Search("CustomerGatewaySet[].State", output)
		if err != nil {
			return false, fmt.Errorf("error evaluating waiter state: %w", err)
		}
...
// CustomerGatewayStoppedWaiterOptions are waiter options for
// CustomerGatewayStoppedWaiter
type CustomerGatewayStoppedWaiterOptions struct {
	...
	// MaxDelay is the maximum amount of time to delay between retries. If unset or set
	// to zero, CustomerGatewayStoppedWaiter will use default max delay of 120 seconds.
	// Note that MaxDelay must resolve to value greater than or equal to the MinDelay.
	MaxDelay time.Duration
...
type CustomerGatewayStoppedWaiter struct {
	...
	options CustomerGatewayStoppedWaiterOptions
}
...
func NewCustomerGatewayStoppedWaiter(client DescribeCustomerGatewaysAPIClient, optFns ...func(*CustomerGatewayStoppedWaiterOptions)) *CustomerGatewayStoppedWaiter {
	...
	options.MinDelay = 20 * time.Second
	options.MaxDelay = 120 * time.Second
	options.Retryable = customerGatewayStoppedStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &CustomerGatewayStoppedWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for CustomerGatewayStopped waiter. The maxWaitDur
// is the maximum wait duration the waiter will wait. The maxWaitDur is required
// and must be greater than zero.
func (w *CustomerGatewayStoppedWaiter) Wait(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayStoppedWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for CustomerGatewayStopped waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *CustomerGatewayStoppedWaiter) WaitForOutput(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayStoppedWaiterOptions)) (*DescribeCustomerGatewaysOutput, error) {
	if maxWaitDur <= 0 {
		return nil, fmt.Errorf("maximum wait time for waiter must be greater than zero")
	}
	...
	return nil, fmt.Errorf("exceeded max wait time for CustomerGatewayStopped waiter")
}

func customerGatewayStoppedStateRetryable(ctx context.Context, input *DescribeCustomerGatewaysInput, output *DescribeCustomerGatewaysOutput, err error) (bool, error) {
...
// CustomerGatewayWarningWaiterOptions are waiter options for
// CustomerGatewayWarningWaiter
type CustomerGatewayWarningWaiterOptions struct {
	...
	// MaxDelay is the maximum amount of time to delay between retries. If unset or set
	// to zero, CustomerGatewayWarningWaiter will use default max delay of 120 seconds.
	// Note that MaxDelay must resolve to value greater than or equal to the MinDelay.
	MaxDelay time.Duration
...
type CustomerGatewayWarningWaiter struct {
	...
	options CustomerGatewayWarningWaiterOptions
}
...
func NewCustomerGatewayWarningWaiter(client DescribeCustomerGatewaysAPIClient, optFns ...func(*CustomerGatewayWarningWaiterOptions)) *CustomerGatewayWarningWaiter {
	...
	options.MinDelay = 20 * time.Second
	options.MaxDelay = 120 * time.Second
	options.Retryable = customerGatewayWarningStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &CustomerGatewayWarningWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for CustomerGatewayWarning waiter. The maxWaitDur
// is the maximum wait duration the waiter will wait. The maxWaitDur is required
// and must be greater than zero.
func (w *CustomerGatewayWarningWaiter) Wait(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayWarningWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for CustomerGatewayWarning waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *CustomerGatewayWarningWaiter) WaitForOutput(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayWarningWaiterOptions)) (*DescribeCustomerGatewaysOutput, error) {
	if maxWaitDur <= 0 {
		return nil, fmt.Errorf("maximum wait time for waiter must be greater than zero")
	}
	...
	return nil, fmt.Errorf("exceeded max wait time for CustomerGatewayWarning waiter")
}

func customerGatewayWarningStateRetryable(ctx context.Context, input *DescribeCustomerGatewaysInput, output *DescribeCustomerGatewaysOutput, err error) (bool, error) {
...
// CustomerGatewayDeletedWaiterOptions are waiter options for
// CustomerGatewayDeletedWaiter
type CustomerGatewayDeletedWaiterOptions struct {
	...
	// MaxDelay is the maximum amount of time to delay between retries. If unset or set
	// to zero, CustomerGatewayDeletedWaiter will use default max delay of 120 seconds.
	// Note that MaxDelay must resolve to value greater than or equal to the MinDelay.
	MaxDelay time.Duration
...
type CustomerGatewayDeletedWaiter struct {
	...
	options CustomerGatewayDeletedWaiterOptions
}
...
func NewCustomerGatewayDeletedWaiter(client DescribeCustomerGatewaysAPIClient, optFns ...func(*CustomerGatewayDeletedWaiterOptions)) *CustomerGatewayDeletedWaiter {
	...
	options.MinDelay = 20 * time.Second
	options.MaxDelay = 120 * time.Second
	options.Retryable = customerGatewayDeletedStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &CustomerGatewayDeletedWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for CustomerGatewayDeleted waiter. The maxWaitDur
// is the maximum wait duration the waiter will wait. The maxWaitDur is required
// and must be greater than zero.
func (w *CustomerGatewayDeletedWaiter) Wait(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayDeletedWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for CustomerGatewayDeleted waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *CustomerGatewayDeletedWaiter) WaitForOutput(ctx context.Context, params *DescribeCustomerGatewaysInput, maxWaitDur time.Duration, optFns ...func(*CustomerGatewayDeletedWaiterOptions)) (*DescribeCustomerGatewaysOutput, error) {
	if maxWaitDur <= 0 {
		return nil, fmt.Errorf("maximum wait time for waiter must be greater than zero")
	}
	...
	return nil, fmt.Errorf("exceeded max wait time for CustomerGatewayDeleted waiter")
}

func customerGatewayDeletedStateRetryable(ctx context.Context, input *DescribeCustomerGatewaysInput, output *DescribeCustomerGatewaysOutput, err error) (bool, error) {
