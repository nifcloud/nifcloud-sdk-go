...
// Resolver storage endpoint resolver
...
var defaultPartitions = endpoints.Partitions{
	{
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			endpoints.DefaultKey{
				...
				Hostname:          "{region}.storage.api.nifcloud.com",
...
func GetDNSSuffix(id string, options Options) (string, error) {
	...
	switch {
	case strings.EqualFold(id, "nifcloud"):
		switch variant {
		case 0:
			return "api.nifcloud.com", nil
...
func GetDNSSuffixFromRegion(region string, options Options) (string, error) {
	switch {
	case partitionRegexp.Nifcloud.MatchString(region):
		return GetDNSSuffix("nifcloud", options)
