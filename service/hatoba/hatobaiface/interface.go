...
// Package hatobaiface provides an interface to enable mocking the NIFCLOUD Kubernetes Service Hatoba service client
...
type ClientAPI interface {
	...
	GetLoadBalancerRequest(*hatoba.GetLoadBalancerInput) hatoba.GetLoadBalancerRequest
	...
	ListLoadBalancersRequest(*hatoba.ListLoadBalancersInput) hatoba.ListLoadBalancersRequest
